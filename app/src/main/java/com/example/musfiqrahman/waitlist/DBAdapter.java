...
public class DBAdapter {
    ...
    public static final String KEY_PARTYSIZE = "partysize";
   ...
   // public static final int COL_FAVCOLOUR = 3;
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_PARTYSIZE};
    ...
    //removed favcolour parameter
    public long insertRow(String name, int studentNum) {
        // [TO_DO_A8]
